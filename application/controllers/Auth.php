...
class Auth extends CI_Controller {
    ...
    private function _sendEmail($token, $type) {
        $config = [
            ...
            'smtp_user' => 'sherly.willian.eseen@mhs.politala.ac.id',
            'smtp_pass' => 'hssy otgw lsvf ubyb',
            'smtp_port' => 465,
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
            'newline'   => "\r\n"
        ...
        $this->email->from('sherly.willian.eseen@mhs.politala.ac.id', 'hssy otgw lsvf ubyb');
